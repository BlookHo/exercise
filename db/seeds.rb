...
GroupEvent.create([
  { user_id: 1, start: '2017-01-20 10:00:00', stop: '2017-01-22 18:00:00', duration: 2, name: 'Developers Meeting', description: 'Fine meeting with developers in office', markdown_description: '', location: 'Tokyo', published: true, deleted: false },
  ...
  { user_id: 1, start: '2017-02-15 10:00:00', stop: '2017-02-25 18:00:00', duration: 10, name: 'Coding', description: 'DEveloping of main Back-end in Project#22 in office', markdown_description: '', location: 'Minsk', published: true, deleted: false },
  ...
  { user_id: 1, start: '2017-01-25 11:00:00', stop: '2017-03-23 19:00:00', duration: 55, name: 'Startup Launch', description: 'Launch of new startup according to the Project#15', markdown_description: '', location: 'Boston', published: true, deleted: false },
